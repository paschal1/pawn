...
INSERT INTO `users` (`user_id`, `firstname`, `middlename`, `lastname`, `address`, `email`, `contact`, `username`,  `phone`, `password`, `gender`, `birthday_date`) VALUES
(1, '0987', '0987', '0987', '0987', '0987', '0987', '0987', '08120062780','a1Bz20ydqelm8m1wql9e1e06ec8e02f0a0074f2fcc6b26303b','Male','01/15/2020'),
(2, 'pascah', 'Vincent', 'Ramos', 'Luisiana', 'email@email', '8979677836432', 'pascah', '08130062780','a1Bz20ydqelm8m1wql60d6acbd6aa032526c5ebf214719d427','Male','01/15/2020'),
(3, 'myperson', 'Patrick', 'Boss', 'Louis', 'none', '83954390', 'clarkpogi', '08123062780','a1Bz20ydqelm8m1wql7c6f5bdc16b3748b481fb5ea98bd4ace','Male','01/15/2020'),
(4, 'John Shalom', 'nwokeocha', 'Barlos', 'jkfhjksdhfjks', 'jerushalombarlos@gmail.com', '8998989', 'chikeze', '08123006780','a1Bz20ydqelm8m1wql827ccb0eea8a706c4c34a16891f84e7b','Female','01/15/2020'),
(5, 'Halt', 'Jr', 'Den', 'espn', 'harryden@mail.com', '9876543210', 'people', '08123006270','a1Bz20ydqelm8m1wqld3915844cde56f2dccfd24c7d34d12f0','Female','01/15/2020');
--
...
INSERT INTO `user_post` (`post_id`, `user_id`, `post_txt`, `post_time`, `priority`,`post_pic`) VALUES
(4, 1, 'Join pawn','18-9-2013 22:10', 'Public','');
...
CREATE TABLE IF NOT EXISTS `user_status` (
  `status_id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `status`  datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `user_status_product` (
