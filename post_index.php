    ...
    <section>
        <div class="bg">
            ...
            <div class="container-fluid">
                ...
                <div style="position:absolute;left:85.6%; top:14.8%;"> <a href="chat.php" style="text-decoration:none;">
                        <input type="button" value="Chats" id="sign_button"> </a> </div>
        ...
        font-family: 'Times New Roman', Times, serif; font-size:20px;">Members</div>
                ...
                <div class="container">
                            ...
                            <div class="container">
                                ...
                                <form method="post" action="" enctype="multipart/form-data" name="post_pic" id="formdata">
                                    ...
                                    <div style="position:absolute; left:36.3%; top:35%; width:5.9%;" class="form-group">
                                        <input type="text" name="price" class="form-control" style="height:30; width:100;" placeholder="Enter Price" id="price">
                                    </div>
                                    <div style="position:absolute; left:44.7%; top:35%; " class="form-group ">
                                        <input type="text" name="qty" class="form-control" style="height:30; width:100; " placeholder="Enter Qty" id="qty">
                                    </div>
                    ...
                    <div style="position:absolute;left:37.4%; top:40%; height:1; width:37.05%; background-color:#CCCCCC; ">
                        <br>
                        ...
                        <div>
                                ...
                                ?>
                                    ...
                                    post i want the page note to reload when submit button is clicked -->
                                             ...
                                             or do both programatically from a function -->
                                                        ...
                                                        <button type="button" name="send_message" class="btn btn-success btn-round pull-right submit" data-toggle="modal" data-target="#myModal">
                                    ...
                                    post i want the page note to reload when submit button is clicked -->
                                                ...
                                                <span> &nbsp; <input type="button" value="Comment(<?php echo $count; ?>)" style="background:#FFFFFF; border:#FFFFFF;font-size:15px; color:#6D84C4;" onClick="Comment_focus(<?php echo $post_id; ?>);" onMouseOver="Comment_underLine(<?php echo $post_id; ?>)" onMouseOut="Comment_NounderLine(<?php echo $post_id; ?>)" id="comment<?php echo $post_id; ?>">
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            ?>
                                ...
                                ?>
                                    <tr>
                                        <td> </td>
                                        <td bgcolor="#EDEFF4" style="padding-left:7;" colspan="2"><img src="../uploads/profile/<?php echo $user_pic; ?> " height="20px" width="20px" border-radius="50px" /> <?php echo '<b>' . $user_name . '</b>'; ?>
                                            <?php echo '<b>' . $user_name2 . '</b>'; ?> <?php echo '<b>' . $user_name3 . '</b>'; ?>
                                            <?php echo $cline1; ?></td>
                                    </tr>
                                <?php
