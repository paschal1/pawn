...
<div class="form-group" style="position:absolute;left:75.6%; top:5.18%; font-size:13px; ">  <input type="submit" title="Search" class="form-control" value="search" class="form control search-query" src="assets/img/search.png" alt="Search" /></div>
<div class="form-group" style="position:absolute;left:81.8%;top:5.2%; ">  <input type="text" name="search" class="form-control" class="form control search-query" placeholder="Search Pawn Users" onkeydown="searchq()" style="width:149.5;" ></div>
<div class="countryList" id="countryList" style="postion:absolute; width:235px; z-index:1001;"></div>
<!-- <div style="position:absolute;left:90.8%;top:4.2%; width=20px; height=12px; ">   <a href=""><img src="img/pawn-logo.PNG"></a>  </div> -->   
		                        </form> 
...
<div style="position:absolute;left:85.6%; top:14.8%;"> <a href="chat.php" style="text-decoration:none;"> <input type="button" value="Chats" id="singup_button">    </a> </div>
...
<div style="position:absolute; left:76.4%; top:26.2%;">  <font size="4"> Pawn Chats </font>  </div>
<div style="position:absolute; left:85%; top:30%; color:black; font-size:11px;"> <font face="myFbFont">Meet with People and make more sells. </font></div>

<div style="position:absolute;left:75.4%; top:32.8%; height:1; width:22.05%; background-color:#CCCCCC; "> 
...
<form method="post" action="" enctype="multipart/form-data"  name="post_pic" id="formdata">
<div style="position:absolute; left:37.5%; top:21.5%;" class="form-group ">
	...
	<input type="text" name="price" class="form-control" style="height:30; width:100;" placeholder="Enter Price" id="price"></div>
	<div style="position:absolute; left:44.7%; top:35%; " class="form-group ">
	<input type="text" name="qty" class="form-control" style="height:30; width:100; " placeholder="Enter Qty" id="qty"></div>
...
<input type="file" id="profileImage" id="postimage" onchange="displayImage(this)" name="post_pic" style="display:none;" multiple>
</div>
<div style="position:absolute; left:69.5%; top:25%; " id="upload" class="form-group">	
		<input class="btn btn btn-default submit" type="submit" value="Upload" name="file" id="profileImage" onClick="time_get()"/>	
	</div>
</form>
			</div>
		</div>
...
foreach($result as $post_data){
	...
	<div>
	 ...
	 <?php echo $output; ?></div>
			...
			<?php if($post_img != ""):?>
			<img src="../uploads/<?php echo $post_img; ?>" width="450px" height="100px" class="img-thumbnail"/>
			...
			<form method="post" >
			<span> <a href="user_post_details.php?post_id=<?php echo $post_id;?>"><button type="button" class="btn btn-warning btn-xs edit" id="<?php echo $post_data[1];?>">Order</button></a>
			</form>
			...
			<button type= "submit" name="send_message" class="btn btn-success btn-round pull-right submit" data-toggle="modal" data-target="#myModal">
        ...
        <?php if($user_pic != ""):?>
		<img  src="../uploads/profile/<?php echo $user_pic2; ?> " height="20px" width="20px" border-radius="50px"/> 
  		<?php else: ?>
  		  <img src="img/user.jpeg" style=" height:20; width:20; border-radius:50px;"/>
   		 <?php endif; ?>
		  <?php }?>
        Drop your comment...</button>
		<form method="post" action="" class="form-group" id="comment1">
        ...
        <input type="submit" class="submit" title="submit" name="subcomment" src="img/sendtext.PNG" alt="Send" width=30px height=22px />
...
$count = $statement->rowCount();
	...
	<span> &nbsp; <input type="button" value="Comment(<?php echo $count; ?>)" style="background:#FFFFFF; border:#FFFFFF;font-size:15px; color:#6D84C4;" onClick="Comment_focus(<?php echo $post_id; ?>);" onMouseOver="Comment_underLine(<?php echo $post_id; ?>)" onMouseOut="Comment_NounderLine(<?php echo $post_id; ?>)" id="comment<?php echo $post_id; ?>">  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <span style="color:#999999;">   <?php// echo $post_data[]; ?> </span> </span>
		</div>
	...
	<tr>
		<td> </td>
		<td bgcolor="#EDEFF4" style="padding-left:7;" colspan="2"><img  src="../uploads/profile/<?php echo $user_pic; ?> " height="20px" width="20px" border-radius="50px"/> <?php echo '<b>'.$user_name.'</b>';?> <?php echo '<b>'.$user_name2.'</b>';?>  <?php echo '<b>'.$user_name3.'</b>';?>  <?php echo $cline1; ?></td>
	</tr>
	<?php
	}
        ...
        $(window).scroll(function(){
            if($(window).scrollTop()==$(document).height()-$(window).height()){
				...
				if(load*4 > num){
					...
					$.post("fetch.php",{load:load},function(data){
...
<script type="text/javascript" src="Profile_js/pagination.js">
</html>
