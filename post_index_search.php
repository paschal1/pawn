...
<div class="main">
    ...
    <div class="section" id="carousel">
        <div class="container">
            <h2></h2>
            <a class="btn btn-edit btn-round" href="post_index.php"><i class="now-ui-icons arrows-1_minimal-left"></i> &nbsp Back to index</a>
            <hr color="orange">
            <div class="col-md-12">
...
<div  class="wrapper">
    ...
    <?php echo $output; ?></div>
           ...
           <button type= "submit" name="send_message" class="btn btn-success btn-round pull-right" data-toggle="modal" data-target="#myModal">
