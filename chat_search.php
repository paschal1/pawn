...
<div  class="container">
	...
	<form method="POST" class="navbar-form navbar-right">
                                <div style="position:absolute;left:90.8%;top:4.2%; " class="form-group">    <input type="image" title="Search" class="form control search-query" src="assets/img/search.png" alt="Search" /></div>
                                  <div style="position:absolute;left:69.6%; top:5.18%; font-size:13px; " class="form-group">  <input type="text" name="search" class="form control search-query" placeholder="Search Users" onkeydown="searchq()" ></div>
                                </form> 

<div style="position:absolute;left:13.6%; top:14.8%;"> <a href="" style="text-decoration:none;"> <input type="button" value="Chats" id="singup_button">    </a> </div>
